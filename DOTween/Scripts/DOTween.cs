...
namespace DG.Tweening
{
    ...
    public class DOTween
    {
        ...
        internal static bool isCryEditor;
        ...
        static DOTween()
        {
            //isCEEditor = Application.isEditor;
#if DEBUG
            isDebugBuild = true;
#endif
        }
        ...
        public static IDOTweenInit Init(bool? recycleAllByDefault = null, bool? useSafeMode = null, LogBehaviour? logBehaviour = null)
        {
			...
			if (Engine.IsSandbox && !Engine.IsSandboxGameMode || isQuitting) return null;
		...
		*/
        ...
        {
			if (initialized || Engine.IsSandbox && !Engine.IsSandboxGameMode || isQuitting) return;
